...
```
Median disease-free survival time is 481 days (95% CI: [363, 748]). 
...
summary(coxph(agvhd_surv~mtx, bmt))
...
summary(coxph(agvhd_surv ~ mtx + age + male + donorage + cmv + f2m + donorcmv + waittime + hospital, bmt))
